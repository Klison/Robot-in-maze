...
class Robot(object):
    ...
    def sense_state(self):
        ...
        # TODO 3. Return robot's current states
    ...
    def update_Qtable(self, r, action, next_state):
        ...
        if self.learning:
            ...
            # to the given rules
            self.Qtable[self.state][action] = self.Qtable[self.state][action] - self.alpha * self.Qtable[self.state][action] + self.alpha * (r + self.gamma * float(max(self.Qtable[next_state].values()))) 
